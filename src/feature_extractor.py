...
def process_directory(processed_dir,categories,orientations, pixels_per_cell, cells_per_block, visualize):
    """
    ...
    for category in categories:
        ...
        for img_file in tqdm(image_files,desc=f"Processing"):
            ...
            features = compute_hog_features(image, orientations, pixels_per_cell, cells_per_block, visualize)
